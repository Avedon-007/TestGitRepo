...
public class CopyTestCaseFileToTestReportFile
{
	...
	public void copyTestCaseFileToArrayList(String pathToTestCaseFile) throws IOException, ClassNotFoundException, SQLException
	{
		CreateEmptyTestReportFile myObject = new CreateEmptyTestReportFile();
		...
		{
			XSSFSheet mySheet = excelBook.getSheetAt(i);
			
//			int counterOfRows = 0;
			int counterOfRows = mySheet.getPhysicalNumberOfRows();
...
//			counterOfRows++;
	...
	public void fillTestReportFile()
	{
